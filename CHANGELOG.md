...
- Diagnostic-Auswertung für `preisfehler` dokumentiert: Alt-Power und eTools liefern parsebare Treffer, Kiddle wird bei ausschließlich gesponserten Treffern korrekt als leer gewertet und Marginalia als Provider-Block erkannt; Google/Qwant bleiben blockiert.
- Regressionstests für deaktivierte Google-CSE-Wrapper und Ecosia-Consent-Metadaten korrigiert.
- eTools-Parser auf table.result-Zeilen erweitert; Werbezeilen werden �bersprungen und organische Treffer vollst�ndig �bernommen.
