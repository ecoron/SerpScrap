...
FIELD_DEFINITIONS = (
    ...
    ("use_own_ip", "search", "Use own IP", "boolean", "Disable only when proxy_file or proxy_sources is configured and approved.", True, False, None, None),
    ...
    ("proxy_enabled", "network", "Enable proxy pool", "boolean", "Use validated configured proxy sources instead of the own IP.", True, False, None, None),
    ("proxy_sources", "network", "Proxy sources", "json", "File, directory, or HTTPS proxy source definitions.", True, False, None, None),
    ("proxy_source_timeout", "network", "Proxy source timeout", "number", "Maximum wait for a remote proxy source.", True, True, 1, 120),
    ("proxy_source_max_bytes", "network", "Proxy source size limit", "number", "Maximum bytes downloaded from one proxy source.", True, True, 1024, 100000000),
    ("proxy_cache_dir", "network", "Proxy source cache", "text", "Filesystem cache for remote proxy source payloads.", True, False, None, None),
    ("proxy_cache_ttl", "network", "Proxy cache lifetime", "number", "How long a remote source payload may be reused in seconds.", True, True, 0, 86400),
    ("proxy_allowed_protocols", "network", "Allowed proxy protocols", "list-text", "Protocols accepted from source data.", True, False, None, None),
    ("proxy_allowed_countries", "network", "Allowed proxy countries", "list-text", "Optional ISO country-code allowlist for source records.", True, False, None, None),
    ("proxy_max_age_seconds", "network", "Maximum source record age", "number", "Ignore records older than this many seconds; zero disables the age filter.", True, True, 0, 31536000),
    ("proxy_max_endpoints", "network", "Maximum proxy endpoints", "number", "Maximum candidates retained after filtering.", True, True, 1, 10000),
    ("proxy_check_url", "network", "Proxy check URL", "url", "Endpoint used to verify proxy connectivity.", True, False, None, None),
    ("proxy_check_timeout", "network", "Proxy check timeout", "number", "Maximum wait for one proxy health check.", True, True, 1, 120),
    ("proxy_failure_threshold", "network", "Proxy failure threshold", "number", "Failures before a proxy enters cooldown.", True, True, 1, 20),
    ("proxy_auto_refresh_enabled", "network", "Automatic proxy refresh", "boolean", "Check configured proxy sources and health in the background.", True, False, None, None),
    ("proxy_auto_refresh_interval_seconds", "network", "Proxy refresh interval", "number", "Background proxy refresh interval in seconds. Default: 900.", True, True, 60, 86400),
